            ...
            <div class="w3-row-padding w3-margin-top">
            	<div class="w3-col m12 wow bounceIn">
                	<div class="table-box wh w3-left">
                    	<div class="box-head">
                        	<h3>Transfer Amount To User Wallet</h3>
                        </div>
						<?php
						$msg="";
						if(isset($_POST['TransferWallet']))
						{
							...
							if($tpin==$logged_tpin)
							{
								...
								if($amount>0)
								{
									transfer_admin_to_user($touser, $amount, $remarks, $remarks_admin);
								}
                        ...
                        <form class="wh w3-left" id="show-det" method="post">
                        	<div class="w3-row-padding w3-margin-bottom">                                 
                                ...
                                <div class="w3-col m6 l4 w3-margin-top">
                                	<label>AMOUNT</label>
									<input type="hidden" id="touser" name="touser" value="<?php echo $uid;?>" />
