...
function create_retailer($uname, $uadhar, $uemail, $umob, $upass, $uadd, $ucity, $udist, $ustate, $upincode, $ugender, $utype, $usoftware, $usecurity, $joinedby, $logged_user_id, $logged_user_name, $logged_user_typename, $logged_user_type)
{
	require('zc-gyan-info-admin.php');
	require('zc-commons-admin.php');
	$last_id=0;
	...
	*/
	if($last_id>0)
	{
		...
		//source 1 NEFT  (8-35)
		$query5a=$query5."(NULL,'$last_id',5,1,9.5,10.5,20,30,40,0,0,0,0)";
		mysql_query($query5a);
		//source 1 IMPS
		$query5b=$query5."(NULL,'$last_id',5,2,9.5,10.5,20,30,40,0,0,0,0)";
		mysql_query($query5b);
		//send sms
	}
	return $last_id;
