            ...
            <div class="w3-row-padding w3-margin-top">
            	<div class="w3-col m12 wow bounceIn">
                	<div class="table-box wh w3-left">
						...
						/**************************/
						$s1=$s2=$s3=$s4="";
						$cond=" where 1=1 and mmt_status in(-1,-2) and type=1 and source=1 ";
						...
						?>
                    	<div class="box-head">
                        	<h3>QUEUED TRANSACTIONS - EKO - Domestic Money Transfer <span class="w3-right w3-blue w3-center badges"><?php echo $total_records;?></span></h3>
                        </div>
                        <div class="table-div wh w3-left">
                        	<ul>
								...
								while($mmt_row=mysql_fetch_array($mmt_result))
								{
									...
									if($mmt_row['source']==1 && $mmt_status2!=5 && $dt2-$dt1<=2592000 && $mmt_row['type']==1)
									{
										$oidcheck=$mmt_row['mmt_id'];
										$recheck=" &nbsp;<img title='Re-Check Status of Order $oidcheck' src='img/refresh-icon.png' onclick='recheck(\"$oidcheck\",\"$mmt_status2\",\"$oidcheck\")'>";
									}
									...
									{
										if($mmt_row['source']==1 && $_REQUEST['check']=="check" && $expno==$oidcheck && $mmt_status2!=5 && $dt2-$dt1<=2592000 && $mmt_row['type']==1)
										{
											$oidcheck=$mmt_row['mmt_id'];
											$process=" &nbsp;<button onclick='process(\"$oidcheck\",\"$mmt_status2\",\"$oidcheck\")'class='w3-button w3-orange w3-round w3-right'>Process</button>";
										}
									}
                                ...
                                <li>
                                    ...
                                    <span><?php echo show_client_name($mmt_row['client_id']);?><br><?php echo $mmt_row['user_id'];?></span>
