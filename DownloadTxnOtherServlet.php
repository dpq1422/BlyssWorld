            ...
            <div class="w3-row-padding w3-margin-top">
            	<div class="w3-col m12 wow bounceIn">
                	<div class="table-box wh w3-left">
						...
						<?php
						if($total_records>0 && $s2!="")
						{
						?>
                                    <li>
										<label>User Name</label>
                                        <input name="s1" value="<?php echo show_user_name($s2);?>" disabled readonly class="w3-input w3-border w3-round">
                                    </li>
                                    <li>
										<label>User Type</label>
                                        <input name="s1" value="<?php echo show_user_type_name(show_user_type($s2));?>" disabled readonly class="w3-input w3-border w3-round">
                                    </li>
                                    <li>
										<label>&nbsp;</label>
										<a href="DownloadUserTxnOtherServlet?1=1<?php echo $qr;?>" class="w3-button w3-blue w3-round">Download Excel</a>
                                    </li>  
						<?php
						}
						?>
                        	...
                        	<ul>
								...
								while($user_row=mysql_fetch_array($user_result))
								{
									...
									if($txn_type==3)
										...
										$txn_type="<b class='w3-text-green'>DTH RC</b>";
									else if($txn_type==5)
										$txn_type="<b class='w3-text-orange'>POSTPAID</b>";
									else if($txn_type==6)
										$txn_type="<b class='w3-text-red'>ELECTRICITY</b>";
									else if($txn_type==7)
										$txn_type="<b class='w3-text-red'>WATER</b>";
									else if($txn_type==8)
										$txn_type="<b class='w3-text-red'>GAS</b>";
									else if($txn_type==9)
										$txn_type="<b class='w3-text-red'>LANDLINE/BROADBAND</b>";
									else if($txn_type==10)
										$txn_type="<b class='w3-text-red'>DATACARD</b>";
									else if($txn_type==11)
										$txn_type="<b class='w3-text-red'>INSURANCE</b>";
