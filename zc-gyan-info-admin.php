...
$wdates="2018-07-01";//"2018-10-26";
$tdates="2018-07-01";//"2018-08-08";

$clientdbid="2000";
$clientdbtype="2";
$main_admin="100001";
$sub_admin1="-999";//100006
$sub_admin2="-999";//100010
$testing1="-999";//100002
$testing2="-999";//100007
$main_team1="-999";//100004
$main_team2="-999";//100149
$abhishek="1001001";
$dt_upto="2018-07-01 00:00:00";
...
$bankapi_child_base2="bankapi_child1_1000_base";
...
$bankapi_child_wallet2="bankapi_child1_1000_wallet";

$call_mt3_url_demo="http://blyssworld.com/callsrc/call_demo_API.php";
$call_mt4_url_demo="http://localhost/design-2018/0000-blyss-world/callsrc/call_live_API7.php";
...
$call_mt4_url_live="http://blyssworld.com/callsrc/call_live_API7.php";
$call_rc1_url_live="http://blyssworld.com/callsrc/rc_ap_live.php";
$call_rc2_url_live="http://blyssworld.com/callsrc/rc_ra_live6.php";

$call_mt3_url=$call_mt3_url_demo;
$call_mt4_url=$call_mt4_url_demo;
...
if($domain_name!="localhost")
{
	...
	$bankapi_child_base2="bankatyf_child1_1000_base";
	...
	$bankapi_child_wallet2="bankatyf_child1_1000_wallet";
	$username = "bankatyf_master";
	$password = "mse!@#123";//master
	$call_mt3_url=$call_mt3_url_live;
	$call_mt4_url=$call_mt4_url_live;
