                        ...
                        <div class="w3-responsive">
                            ...
                            <table class="w3-table-all" id="myTable" style="border:none;">
								...
								while($margin_row=mysql_fetch_array($margin_result))
								{
									...
									$min=show_mt_margin($logged_user_id, $source_id, $payment_method);
									$min=array($min[0],$min[1],$min[2],$min[3],$min[4]);
									//$min=array($min[0]+1,$min[1]+1,$min[2]+1,$min[3]+1,$min[4]+1);
									...
									if($usertype==12)
									{
										$min=array($min[0],$min[1],$min[2]+3,$min[3]+3,$min[4]+3);
