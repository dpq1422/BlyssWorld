<?php
function find_sender25($useridlogged,$cno)
{
...
function add_sender25($useridlogged, $cno, $cname)
{
	require('zc-gyan-info-admin.php');
	$return_result="";
...
function verify_sender25($useridlogged,$cno,$ccode,$cotp)
{
	require('zc-gyan-info-admin.php');
	$return_result="";
...
function show_beneficiary25($useridlogged,$cno)
{
	require('zc-gyan-info-admin.php');
	$return_result="";
...
function remove_beneficiary25($cno,$benid)
{
	require('zc-gyan-info-admin.php');
	$return_result="";
...
function add_beneficiary_without_verify25($cno,$rname,$rbacc,$rbifsc,$bank_code)
{
	require('zc-gyan-info-admin.php');
	$return_result="";
...
function add_beneficiary_with_verify25($cno,$cname,$racc,$ifsc,$pan,$aadhar,$order_number)
{
	require('zc-gyan-info-admin.php');
	$return_result="";
...
function fund_transfer25($orderno,$cno,$cname,$brid,$account,$ifsc,$method,$transamount,$pan,$aadhar)
{
	require('zc-gyan-info-admin.php');
	require('zc-commons-admin.php');
	$return_result="";
...
function fund_transfer_order_status25($order)//CHECK_ORDER_STATUS
{ 	
	require('zc-gyan-info-admin.php');
	$return_result="";
...
function fund_transfer_txn_status25($tid)//FUND_TRANSFER_STATUS
{ 	
	require('zc-gyan-info-admin.php');
	$return_result="";
...
function fund_transfer_refund_otp_25($tid)//FUND_REFUND_OTP_RESEND
{ 	
	require('zc-gyan-info-admin.php');
	require('zc-commons-admin.php');
	$return_result="";
...
function fund_transfer_refund_25($order_number,$tid,$otp)//FUND_REFUND
{ 	
	require('zc-gyan-info-admin.php');
	require('zc-commons-admin.php');
	$return_result="";
...
function fund_transfer_refund_otp2_25($mid)//FUND_REFUND_OTP_RESEND2
{
	require('zc-gyan-info-admin.php');
	require('zc-commons-admin.php');
	$message="Success!Refund OTP resent";
...
function fund_transfer_refund2_25($mid,$otp)//FUND_REFUND2
{ 	
	require('zc-gyan-info-admin.php');
	require('zc-commons-admin.php');
...
function show_bank_filtered5($cond)
{
	require('zc-gyan-info-admin.php');
	require('zc-commons-admin.php');
...
function show_bank_verification_availability5($bank_code)
{
	require('zc-gyan-info-admin.php');
	require('zc-commons-admin.php');
	$verify=0;
...
function order_clientid_clienttypeid_by_mid25($m_id)
{
	require('zc-gyan-info-admin.php');
	require('zc-commons-admin.php');
	...
	$mid=0;
	$clientid=0;
	$query="SELECT * FROM $bankapi_parent_txn.txn_mt where mmt_id='$m_id';";
	$result=mysql_query($query);
	while($r = mysql_fetch_array($result)) 
	{
		$mid=$r['order_id'];
		$clientid=$r['client_id'];
		require('zf-Client.php');
		$clienttypeid=show_client_type_id($clientid);
	}
	$ar=array($mid,$clientid,$clienttypeid);
	return $ar;
}
?>