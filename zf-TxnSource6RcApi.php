<?php
function start_recharge6($request_number,$mobile_number,$amount,$operator,$circle)
{
...
function check_order_status6($order_number)//api order id
{
	require('zc-gyan-info-admin.php');
	$return_result="";
...
function check_order_status62($order_number)//our order id
{
	require('zc-gyan-info-admin.php');
	$return_result="";
