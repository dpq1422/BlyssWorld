            ...
            <div class="w3-row-padding w3-margin-top">
            	<div class="w3-col m12 wow bounceIn">
                	<div class="table-box wh w3-left">
						...
						$total_records=show_plans_count_commission($cond);
						$user_result=show_plans_data_commission($cond, $start_from, $num_rec_per_page);
						$qr="&s1=$s1&s2=$s2&s3=$s3&s4=$s4&s5=$s5&search=search";
						$i=0;
						?>
                    	<div class="box-head wh w3-left">
                                <h3 class="wh w3-left">Commission Distribution <span class="w3-right w3-blue w3-center badges"><?php echo $total_records;?></span></h3>
                        </div>
                        <div class="table-div wh w3-left">
                        	<ul>
                                ...
                                <li>
                                    ...
                                    <span><?php echo $type.$chg;?></span>
                                    <span><?php echo $user_row['plan_1'];?></span>
                                    <span><?php echo $user_row['plan_2'];?></span>
                                    <span><?php echo $user_row['plan_3'];?></span>
                                    <span><?php echo $user_row['plan_4'];?></span>
                                    <span><?php echo $user_row['plan_5'];?></span>
                                </li>
								<?php
								}
								?>
								<li>
									<div class="w3-row-padding w3-margin-bottom w3-margin-top w3-right-align">
										<a href="PlanCommissionUpdateServlet" class="w3-button w3-round w3-blue">Modify Commission</a>
									</div>    
								</li>
                            </ul>
                        </div>                        
