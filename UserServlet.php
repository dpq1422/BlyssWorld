            	...
            	<div class="w3-col m12 wow bounceIn">
                	<div class="table-box wh w3-left">
						...
						if(isset($_POST['CreateUser']))
						{
							...
							create_user($utype, $uname, $uemail, $umob, $upass, $uadd, $ucity, $udist, $ustate, $upincode, $udeps, $ugender, $ustatus, $uremark);
                        	...
                        	<div class="w3-row-padding w3-margin-bottom">  
                                ...
                                <div class="w3-col m6 l4 w3-margin-top">
                                	...
                                	<select name="utype" onchange="showUserRole()" id="utype" class="w3-select w3-border w3-round" name="utype">
                                        ...
                                        <option value="-1">Office Staff/User</option>
                                ...
                                <div class="w3-col m6 l4 w3-margin-top" style="position:relative">
                                	...
                                	<input name="upass" value="blyss@12" readonly type="text" id="password" placeholder="Password" class="w3-input w3-border w3-round">
                                    <img src="img/eye.png" class="eye display-none" onclick="myFunction()">
                                </div>
                                
                                <div class="w3-col m6 l4 w3-margin-top display-none" style="position:relative">
                                	<label>Confirm Password</label>
                                	<input type="password" value="blyss@12" id="confirm-password" placeholder="Confirm Password" class="w3-input w3-border w3-round">
