...
function check_values() {
	...
	else
	{
		...
		$("#error-message").html("Do you want to change T-PIN?");
		$("#ButtonFirst").hide();
		$("#ButtonSecond").show();
		$("#ViewServlet").show();
		$("#error-box").show();
            ...
            <div class="w3-row-padding w3-margin-top">
            	<div class="w3-col m12 wow bounceIn">
                	<div class="table-box wh w3-left">
						...
						<p><b>T-pin must meet the following requirement:</b><br><br>

1. The T-pin must be of 4 numeric digits only.<br>
2. Spaces are not allowed in the Password.<br>
3. Your New T-pin cannot be the same as any of your previous password.  <br>
</p>
                                </div>                                         
                        	</div>
                        </form>
  ...
  <div id="error-box" class="w3-modal">
    <div class="w3-modal-content w3-animate-zoom w3-card-4 w3-round list-pop">
      ...
      <div class="w3-container w3-center">
      	<p id="error-message">Do you want to change T-PIN?</p>
      </div>  
