								...
								<ul>
                                    ...
                                    <li>
                                        ...
                                        <select name="s3" class="w3-input w3-border w3-round">
                                            ...
                                            <option value='-1' <?php if($s3==-1) echo "selected";?>>Office Staff/User</option>
                                        </select>
                                    </li>
                                    <li>
                                        ...
                                        <select name="s4" class="w3-input w3-border w3-round">
											<option value=''>Select User</option>
                                            <option value='1' <?php if($s4==1) echo "selected";?>>Master</option>
                                            <option value='2' <?php if($s4==2) echo "selected";?>>Team</option>
                                            <option value='3' <?php if($s4==3) echo "selected";?>>Wallet</option>
                                            <option value='4' <?php if($s4==4) echo "selected";?>>Transaction</option>
                                            <option value='5' <?php if($s4==5) echo "selected";?>>Support</option>
                                            <option value='6' <?php if($s4==6) echo "selected";?>>Commission</option>
                                            <option value='7' <?php if($s4==7) echo "selected";?>>Audit</option>
                                            <option value='8' <?php if($s4==8) echo "selected";?>>Report</option>
                                        </select>
                                    </li>
                                    <li>
										<label>Status</label>
                        ...
                        <div class="table-div wh w3-left">
                        	<ul>
								...
								while($user_row=mysql_fetch_array($user_result))
								{
									...
									if($user_type==1)
										$user_type="<b class='w3-text-green'>Application Admin</b>";
									else if($user_type==0)
										$user_type="<b class='w3-text-red'>Application Wallet</b>";
									else if($user_type==-1)
										$user_type="<b class='w3-text-blue'>Office Staff/User</b>";
									...
									//$st_link="$st_link
										//<button onclick='location.href=\"ResetUserPasswordServlet?uid=$userid\";' class='w3-button w3-green w3-round'>Reset Password (blyss@12)</button>";
