...
<html>
<head>
<title>BlyssWorld.com :: Affiliate Model</title>
<?php 
...
//var newTab = window.open('http://blyssworld.com/', '_blank');
 //newTab.location;
...
<body onload="myFocus()">
	...
	?>
                        	<li>
                                ...
                                <input class="w3-input w3-border w3-white w3-round user" autocomplete="off" placeholder="User ID" name="filled_mobile_no" id="filled_mobile_no" onkeyup="check_user()" maxlength="6" required type="text">
                            </li>
                            <li class="pass-val">
                               <input class="w3-input w3-border w3-white w3-round key" autocomplete="off" id="filled_pass_word" placeholder="Password" maxlength="8" onkeyup="check_pass()" name="filled_pass_word" required type="password">
                            ...
                            <li class="capt pass-val">
                                ...
                                <input required maxlength="4" autocomplete="off" class="w3-input w3-border w3-round" id='captcha_code' name="captcha_code" type="text">
                            </li>
                        </ul>
                        ...
                        <div class="wh w3-left forgot">
								<a href="RegisterServlet" class="w3-text-blue w3-left display-none">New User ? Register </a>
								<a href="ForgotPasswordServlet" class="w3-text-red w3-right">Forgot your password ?</a>
                        </div>
                    </form>
                </div>
            </div>
