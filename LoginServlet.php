...
<html>
<head>
<title>BlyssWorld.com :: Distributor Model</title>
<?php 
...
<script async src="https://www.googletagmanager.com/gtag/js?id=UA-126322670-12"></script>
<script>
...
<body onload="myFocus()">
	...
	?>
								...
								<li class="pass-val">
								   <input class="w3-input w3-border w3-white w3-round key" id="filled_pass_word" placeholder="Password" maxlength="8" autocomplete="off" onkeyup="check_pass()" name="filled_pass_word" required type="password">
								...
								<li class="capt pass-val">
									...
									<input required maxlength="4" autocomplete="off" onkeyup="check_captcha()" class="w3-input w3-border w3-round" id='captcha_code' name="captcha_code" type="text">
								</li>
							</ul>
...
<section id="tiny" class="tinyslide">
  <aside class="slides">
    <figure><img src="img/loing-center/bgss.jpg" alt="background" /></figure>
  </aside>
</section>
