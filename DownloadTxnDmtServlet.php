            ...
            <div class="w3-row-padding w3-margin-top">
            	<div class="w3-col m12 wow bounceIn">
                	<div class="table-box wh w3-left">
						...
						<?php
						if($total_records>0 && $s3!="")
						{
						?>
                                    <li>
										<label>User Name</label>
                                        <input name="s1" value="<?php echo show_user_name($s3);?>" disabled readonly class="w3-input w3-border w3-round">
                                    </li>
                                    <li>
										<label>User Type</label>
                                        <input name="s1" value="<?php echo show_user_type_name(show_user_type($s3));?>" disabled readonly class="w3-input w3-border w3-round">
                                    </li>
                                    <li>
										<label>&nbsp;</label>
										<a href="DownloadUserTxnDmtServlet?1=1<?php echo $qr;?>" class="w3-button w3-blue w3-round">Download Excel</a>
                                    </li>  
						<?php
						}
						?>
                        ...
                        <div class="table-div wh w3-left">
                        	<ul>
								...
								while($user_row=mysql_fetch_array($user_result))
								{
									...
									if($user_row['source']==3 && $txn_status2>-3 && $txn_status2!=5 && $dt2-$dt1<=2592000 && $user_row['type']==1)
									{
										$oidcheck=$order_id;
										$recheck=" &nbsp;<img title='Re-Check Status of Order $oidcheck' src='img/refresh-icon.png' onclick='recheck3(\"$oidcheck\",\"$txn_status2\",\"$i\")'>";
									}
									if($user_row['mid']==0)
