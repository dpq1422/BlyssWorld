                        ...
                        <div class="table-div wh w3-left">
                        	<ul>
                            	<li class="table-div-head">
                                    ...
                                    <span>ACTIVATION CHARGES MIN MAX</span>
                                    <span>IS ACTIVATION CHARGES DISTRIBUTED</span>
                                    <span>ACTION</span>
                                </li>
								<?php
                                ...
                                <li>
                                	<div class="address<?php echo $i;?> inner-add wh w3-left">
										...
										<p><strong>Distribution level for Activation Charges:</strong> <?php echo $dist;?></p>
