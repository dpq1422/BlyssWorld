...
function txn_recharge($userid, $service, $mobile, $operator_code, $operator, $circle, $amount, $source)
{
	...
	$field="id_12";
	$deduction_retailer=show_user_rc_rate($service,$operator_id,$userid);
...
function mid_by_order($order)
{
	...
	$mid=0;
	$query="SELECT * FROM $bankapi_parent_txn.txn_rc where order_id='$order' and client_id='$clientdbid';";
	$result=mysql_query($query);
	while($r = mysql_fetch_array($result)) 
	{
		$mid=$r['mrc_id'];
	}
	mysql_query("update $bankapi_child_txn.txn_rc set mid='$mid' where rc_id='$order';");
	return $mid;
}
