            	...
            	<div class="w3-col m12 wow bounceIn">
                	<div class="table-box wh w3-left">
						...
						if(isset($_POST['UpdateMpIp']))
						{
							...
							update_mp_info(1000,$cmp);
							echo "<script>window.location.href='AdminUpdateMp';</script>";
						}
						?>
                        <form class="wh w3-left" method="post">
                        	<div class="w3-row-padding w3-margin-bottom">    
                            	<div class="w3-col m6 l4 w3-margin-top">
                                	<label>Your MP Name</b></label>	
                                	<input type="text" maxlength="8" name="cmp" id="cmp" placeholder="Name" class="w3-input w3-border w3-round" value="<?php echo $company_row['mp'];?>">                                    
                                </div>
