            ...
            <div class="w3-row-padding w3-margin-top">
            	<div class="w3-col m12 wow bounceIn">
                	<div class="table-box wh w3-left">
						...
						$earn3=show_unpaid_comm_non_gst2($userids,$dt1,$dt2);
						$earn1=number_format((float)$earn1, 2, '.', '');
						$earn2=number_format((float)$earn2, 2, '.', '');
						$earn3=number_format((float)$earn3, 2, '.', '');
						$gst1=($earn1/118)*18;
						$gst2=($earn2/118)*0;
						$gst3=($earn3/118)*0;
						//$gst1=$earn1*.18;
						...
						if(isset($_POST['PayNow']))
						{
							...
							$tcom=mysql_real_escape_string($_POST['tcom']);//TOTAL
							...
							$com1=mysql_real_escape_string($_POST['com1']);//DMT
							...
							$com2=mysql_real_escape_string($_POST['com2']);//AFFILIATE-DMT
							
							$prd3=mysql_real_escape_string($_POST['prd3']);
							$ern3=mysql_real_escape_string($_POST['ern3']);
							$gst3=mysql_real_escape_string($_POST['gst3']);
							$rem3=mysql_real_escape_string($_POST['rem3']);
							$tds3=mysql_real_escape_string($_POST['tds3']);
							$com3=mysql_real_escape_string($_POST['com3']);//AFFILIATE-RCBILL
							
							$remarks="From date $dt1 to $dt2";
							pay_now_all_new($uid,$tearn,$tgst,$tremain,$ttds,$tcom,$remarks,$dt2,$tds1,$tds2,$tds3,$com1,$com2,$com3);
							gst_tds_new($uid,$dt2,$prd1,$ern1,$gst1,$rem1,$tds1,$com1);
							gst_tds_new($uid,$dt2,$prd2,$ern2,$gst2,$rem2,$tds2,$com2);
							gst_tds_new($uid,$dt2,$prd3,$ern3,$gst3,$rem3,$tds3,$com3);
                        ...
                        <form class="wh w3-left" method="post">
                        	...
                        	<div class="w3-row-padding w3-margin-bottom">                                    
                                <div class="w3-col m6 l2 w3-margin-top">
                                	<input type="text" readonly value="AFFILIATE-DMT" class="w3-input w3-border w3-round" disabled>
									<input type="hidden" name="prd2" value="AFFILIATE-DMT" />
                                </div>
                                
                                <div class="w3-col m6 l2 w3-margin-top">
                                	<input type="text" readonly value="<?php echo $earn3;?>" class="w3-input w3-border w3-round w3-right-align" disabled>
									<input type="hidden" name="ern2" value="<?php echo $earn3;?>" />
                                </div>
                                
                                <div class="w3-col m6 l2 w3-margin-top">
                                	<input type="text" readonly value="<?php echo $gst3;?>" class="w3-input w3-border w3-round w3-right-align" disabled>
									<input type="hidden" name="gst2" value="<?php echo $gst3;?>" />
                                </div>
                                
                                <div class="w3-col m6 l2 w3-margin-top">
                                	<input type="text" readonly value="<?php echo $remain3;?>" class="w3-input w3-border w3-round w3-right-align" disabled>
									<input type="hidden" name="rem2" value="<?php echo $remain3;?>" />
                                </div>
                                
                                <div class="w3-col m6 l2 w3-margin-top">
                                	<input type="text" readonly value="<?php echo $tds3;?>" class="w3-input w3-border w3-round w3-right-align" disabled>
									<input type="hidden" name="tds2" value="<?php echo $tds3;?>" />
                                </div>
                                
                                <div class="w3-col m6 l2 w3-margin-top">
                                	<input type="text" readonly value="<?php echo $tcomm3;?>" class="w3-input w3-border w3-round w3-right-align" disabled>
									<input type="hidden" name="com2" value="<?php echo $tcomm3;?>" />
                                </div> 
							</div> 
							
                        	<div class="w3-row-padding w3-margin-bottom">                                    
                                <div class="w3-col m6 l2 w3-margin-top">
                                	<input type="text" readonly value="AFFILIATE-RCBILL" class="w3-input w3-border w3-round" disabled>
									<input type="hidden" name="prd3" value="AFFILIATE-RCBILL" />
                                </div>
                                
                                <div class="w3-col m6 l2 w3-margin-top">
                                	<input type="text" readonly value="<?php echo $earn2;?>" class="w3-input w3-border w3-round w3-right-align" disabled>
									<input type="hidden" name="ern3" value="<?php echo $earn2;?>" />
                                </div>
                                
                                <div class="w3-col m6 l2 w3-margin-top">
                                	<input type="text" readonly value="<?php echo $gst2;?>" class="w3-input w3-border w3-round w3-right-align" disabled>
									<input type="hidden" name="gst3" value="<?php echo $gst2;?>" />
                                </div>
                                
                                <div class="w3-col m6 l2 w3-margin-top">
                                	<input type="text" readonly value="<?php echo $remain2;?>" class="w3-input w3-border w3-round w3-right-align" disabled>
									<input type="hidden" name="rem3" value="<?php echo $remain2;?>" />
                                </div>
                                
                                <div class="w3-col m6 l2 w3-margin-top">
                                	<input type="text" readonly value="<?php echo $tds2;?>" class="w3-input w3-border w3-round w3-right-align" disabled>
									<input type="hidden" name="tds3" value="<?php echo $tds2;?>" />
                                </div>
                                
                                <div class="w3-col m6 l2 w3-margin-top">
                                	<input type="text" readonly value="<?php echo $tcomm2;?>" class="w3-input w3-border w3-round w3-right-align" disabled>
									<input type="hidden" name="com3" value="<?php echo $tcomm2;?>" />
                                </div> 
							</div> 
