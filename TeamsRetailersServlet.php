								...
								<ul>
                                    ...
                                    <li>
                                        ...
                                        <select name="s4" class="w3-input w3-border w3-round">
                                            ...
                                            <option value='1' <?php if($s4==1) echo "selected";?>>BASIC</option>
                                            <option value='2' <?php if($s4==2) echo "selected";?>>BRONZE</option>
                                            <option value='3' <?php if($s4==3) echo "selected";?>>SILVER</option>
                                            <option value='4' <?php if($s4==4) echo "selected";?>>GOLD</option>
                                            <option value='5' <?php if($s4==5) echo "selected";?>>API-PARTNER</option>
                                            <option value='6' <?php if($s4==6) echo "selected";?>>API</option>
                                        </select>
                                    </li>
                                    <li>
										<label>Status</label>
                        ...
                        <div class="table-div wh w3-left">
                        	<ul>
                            	<li class="table-div-head">
                                    ...
                                    <span>CITY</span>
                                    <span>PLAN</span>
                                    <span>DIR/IND<br>REFFERED</span>
                                    <span>SELF<br>TXNS</span>
								...
								while($user_row=mysql_fetch_array($user_result))
								{
									...
									$is_my_user=isMyRef($mytype,$myid,$userid);
									//$st_link="$st_link<br/><br/>
									$st_link="
										<button onclick='location.href=\"ResetUserPasswordServlet?type=retailer&uid=$userid\";' class='w3-button w3-green w3-round'>Reset Password (blyss@12)</button>
									...
									$parent_id=show_parent_ref_id($user_row['user_id']);
									...
									*/
									...
									$plan_name=show_plan_name($user_row['plan_id']);
									if($user_row['plan_id']==1)
										$plan_name="$plan_name";
									if($user_row['plan_id']==2)
										$plan_name="<b class='w3-text-orange'>$plan_name</b>";
									if($user_row['plan_id']==3)
										$plan_name="<b class='w3-text-green'>$plan_name</b>";
									if($user_row['plan_id']==4)
                                ...
                                <li <?php echo $rowval;?>>
                                    ...
                                    <span><?php echo showMyDirectRefs($user_row['user_id']);?> / <?php echo showMyRefs($user_row['user_id']);?></span>
                                    <span><?php echo showMyTxns($user_row['user_id']);?></span>
                                    <span><?php echo $parent_id;?></span>
