            ...
            <div class="w3-row-padding w3-margin-top">
            	<div class="w3-col m12 wow bounceIn">
                	<div class="table-box wh w3-left">
						<?php
						include_once('../zf-TxnService2TeamAff.php');
						...
						?>
                    	<div class="box-head">
                        	<h3>TRANSACTIONS - RC/Others <span class="w3-right w3-blue w3-center badges"><?php echo $total_records;?></span></h3>
                        </div>
                        ...
                        <div class="table-div wh w3-left">
                        	<ul>
								...
								{/*
									...
									if($txn_type==3)
										$txn_type="<b class='w3-text-green'>PREPAID</b>";
									else if($txn_type==4)
										$txn_type="<b class='w3-text-green'>DTH</b>";
									else if($txn_type==5)
										$txn_type="<b class='w3-text-green'>POSTPAID</b>";
									else if($txn_type==6)
										$txn_type="<b class='w3-text-blue'>ELECTRICITY</b>";
									else if($txn_type==7)
										$txn_type="<b class='w3-text-blue'>WATER</b>";
									else if($txn_type==8)
										$txn_type="<b class='w3-text-blue'>GAS</b>";
									else if($txn_type==9)
										$txn_type="<b class='w3-text-orange'>LANDLINE/BROADBAND</b>";
									else if($txn_type==10)
										$txn_type="<b class='w3-text-orange'>DATACARD</b>";
									else if($txn_type==11)
										$txn_type="<b class='w3-text-orange'>INSURANCE</b>";
									
									$txn_id=$user_row['rc_id'];
