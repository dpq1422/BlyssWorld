                        	...
                        	<div class="w3-row-padding w3-margin-bottom"> 
                                ...
                                <div class="w3-col m6 l4 w3-margin-top">
                                	...
                                	<select id="pmeth" name="filled_method" class="w3-select w3-border w3-round">
                                        <option value="" required disabled selected>Choose your option</option>
										<?php if($my_current_plan!=6){ ?><option value='5'>Cash Deposit</option><?php } ?>
										<option value='3'>NEFT / RTGS</option>
										<option value='4'>IMPS</option>
										<?php if($my_current_plan!=6){ ?><option value='6'>CDM - Cash Deposit Machine</option><?php } ?>
                                ...
                                <div class="w3-col m6 l4 w3-margin-top">
                                	<label>Ref.No./<?php if($my_current_plan!=6){ echo "Branch Name/CDM Location"; } else { echo "Cheque No./DD.No.";} ?></label>
                                	<input type="text" id="refno" name="filled_refno" required placeholder="Ref.No./<?php if($my_current_plan!=6){ echo "Branch Name/CDM Location"; } else { echo "Cheque No./DD.No.";} ?>" class="w3-input w3-border w3-round">   
								</div>
