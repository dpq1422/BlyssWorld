            ...
            <div class="w3-row-padding w3-margin-top">
            	<div class="w3-col m12 wow bounceIn">
                	<div class="table-box wh w3-left">
						...
						?>
                    	<div class="box-head">
                        	<h3>WALLET REQUESTS SENT TO COMPANY <span class="w3-right w3-blue w3-center badges"><?php echo $total_records;?></span></h3>
                        </div>
						<div class="table-search-filter wh w3-left">
							<form class="wh w3-left" method="get">
								<ul>
                                    <li>
										<a href="DownloadUserRequestServlet?1=1<?php echo $qr;?>" class="w3-button w3-green w3-round w3-text-right">Download Excel</a>
                                    </li>                                   
                                </ul>
                            </form>
                        </div>
