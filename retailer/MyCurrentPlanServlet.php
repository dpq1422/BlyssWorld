...
{
	rs1=parseInt(rs*100);
	wbal1=parseInt(wbal*100);
	//alert(rs1+" "+wbal1+" "+rs1<=wbal1);
	if(rs1<=wbal1)
	{
                	...
                	<div class="table-box wh w3-left">
                        ...
                        <div class="w3-responsive">
                            <table class="w3-table-all" id="myTable" style="border:none;">
								...
								<tr>
									<th colspan='3' class='w3-gray w3-text-white'>Money Remittance</th>
								</tr>
                                <tr>
								...
								<tr>
									<th colspan='3' class='w3-gray w3-text-white'>Prepaid Mobile Recharge</small></th>
								</tr>
								<?php
								...
								?>    
								<tr>
									<th colspan='3' class='w3-gray w3-text-white'>DTH Recharge <small></small></th>
								</tr>
								<?php
								...
								?>    
								<tr>
									<th colspan='3' class='w3-gray w3-text-white'>Postpaid Mobile Bill Payments <small></small></th>
								</tr>
								<?php
								...
								?> 
								<tr>
									<th colspan='3' class='w3-gray w3-text-white'>Electricity Bill Payments <small>(Surcharge extra)</small></th>
								</tr>
								<?php
