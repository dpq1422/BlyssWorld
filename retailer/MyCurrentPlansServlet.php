                	...
                	<div class="table-box wh w3-left">
						...
						while($plan_rs=mysql_fetch_array($plan_result))
						{
							...
							$plan_4=show_plan_details($plan_rs['plan_id']);
										...
										$aaa=show_plan_mt_rates($plan_1['plan_id'])*1.18;
										$aaa=number_format((float)$aaa, 2, '.', '');
										$bbb=show_plan_mt_rates($plan_3['plan_id'])*1.18;
										$bbb=number_format((float)$bbb, 2, '.', '');
										$ccc=show_plan_mt_rates($plan_4['plan_id'])*1.18;
										$ccc=number_format((float)$ccc, 2, '.', '');
						?>
                    	<div class="box-head">
                        ...
                        <div class="w3-responsive">
                            <table class="w3-table-all" id="myTable" style="border:none;">
                                <tr class="w3-blue">
									<th colspan='1'>PLAN AND SERVICES</th>
                                ...
                                <tr>
									<td colspan='1'>Refundable Security</td>
									<td><?php echo $plan_1['plan_security'];?></td>
									<td><?php echo $plan_3['plan_security'];?></td>
									<td><?php echo $plan_4['plan_security'];?></td>
                                </tr>   
								<tr>
									<th colspan='4' class='w3-gray w3-text-white'>Money Remittance</th>
								</tr>
                                <tr>
									<td>100-1000/- Money Transfer (IMPS/NEFT)</td>
									<td><?php echo 10;?></td>
									<td><?php echo 10;?></td>
									<td><?php echo 10;?></td>
                                </tr>   
                                <tr>
									<td>1001-2000/- Money Transfer (IMPS/NEFT)</td>
									<td><?php echo 10;?></td>
									<td><?php echo 10;?></td>
									<td><?php echo 10;?></td>
                                </tr>   
                                <tr>
									<td>2001-5000/- Money Transfer (IMPS/NEFT)</td>
									<td><?php echo $aaa;?></td>
									<td><?php echo $bbb;?></td>
									<td><?php echo $ccc;?></td>
                                </tr>   
                                <tr>
									<td colspan='1'>Account Verification</td>
									<td>5</td>
									<td>5</td>
									<td>5</td>
                                </tr>   
								<tr>
									<th colspan='4' class='w3-gray w3-text-white'>Prepaid Mobile Recharge <small></small></th>
								</tr>
								<?php
								...
								?>
                                <tr>
									<td colspan='1'><?php echo show_operator_name2($planservice_rs['operator_id']);?></td>
								...
								?>    
								<tr>
									<th colspan='4' class='w3-gray w3-text-white'>DTH Recharge <small></small></th>
								</tr>
								<?php
								...
								?>    
								<tr>
									<th colspan='4' class='w3-gray w3-text-white'>Postpaid Mobile Bill Payments <small></small></th>
								</tr>
								<?php
								...
								?> 
								<tr>
									<th colspan='4' class='w3-gray w3-text-white'>Electricity Bill Payments <small>(Surcharge extra)</small></th>
								</tr>
								<?php
								...
								while($planservice_rs=mysql_fetch_array($planservice_result))
								{
									...
									$aaa=$planservice_rs["plan_".$plan_1['plan_id']]*1.18;
									$aaa=number_format((float)$aaa, 2, '.', '');
									$bbb=$planservice_rs["plan_".$plan_3['plan_id']]*1.18;
									$bbb=number_format((float)$bbb, 2, '.', '');
									
									$rate=number_format((float)$rate, 2, '.', '')*1.18;
								?>
                                <tr>
									<td colspan='1'><?php echo show_operator_name2($planservice_rs['operator_id']);?></td>
									<td><?php echo $aaa;?>/Txn</td>
									<td><?php echo $bbb;?>/Txn</td>
									<td><?php echo $rate."0";?>/Txn</td>
                                </tr>  
								<?php
								}/*
								?> 
