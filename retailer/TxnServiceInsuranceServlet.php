            ...
            <div class="w3-row-padding w3-margin-top">
            	<div class="w3-col m12 wow bounceIn">
                	<div class="table-box wh w3-left">
						...
						/**************************/
						$s1=$s2=$s3=$s4=$s5="";
						$cond=" where 1=1 and user_id='$logged_user_id' and type in(11) ";
						...
						?>
                    	<div class="box-head">
                        	<h3>TRANSACTIONS - INSURANCE PREMIUM Renewals <span class="w3-right w3-blue w3-center badges"><?php echo $total_records;?></span></h3>
                        </div>
							...
							<form class="wh w3-left" method="get">
								<ul>
                                    ...
                                    <li>
                                        ...
                                        <input name="s3" id="s3" onclick="clrval()" value="<?php echo $s3;?>" type="text" placeholder="Policy No" class="w3-input w3-border w3-round">
                                    </li>
                                    <li>
										<label>&nbsp;</label>
