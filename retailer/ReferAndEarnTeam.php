            ...
            <div class="w3-row-padding w3-margin-top">
            	<div class="w3-col m12 wow bounceIn">
                	<div class="table-box wh w3-left">
						...
						include_once('../zf-TeamDataAffTeam.php');
						...
						?>
                    	<div class="box-head">
                        	<h3>AFFILIATE USERS AND QUICK STATUS <span class="w3-right w3-blue w3-center badges"><?php echo $total_records;?></span></h3>
                        </div>
						<div class="table-search-filter wh w3-left"></div>
                        ...
                        <div class="table-div wh w3-left">
                        	<ul>
								...
								while($user_row=mysql_fetch_array($user_result))
								{
									...
									$kyc_status=show_user_kyc($user_row['user_id']);
									if($kyc_status==0)
									{
									...
									*/
									$planids=show_user_current_plan($user_row['user_id']);
									$plan_name=show_plan_name($planids);
									if($planids==1)
										$plan_name="$plan_name";
									if($planids==2)
									...
									if($planids==5)
										$plan_name="<b class='w3-text-red'>$plan_name</b>";
									if($planids==6)
										$plan_name="<b class='w3-text-red'>$plan_name</b>";
									
									$txntoday=showMyTxnsToday($user_row['user_id']);
									$txnall=showMyTxns($user_row['user_id']);
								?>
                                <li>
                                    ...
                                    <span><?php echo show_wallet_balance($user_row['user_id']);?></span>
                                    <span><?php echo $txntoday;?></span>
