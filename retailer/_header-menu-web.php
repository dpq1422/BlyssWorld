                    	...
                    	<ul class="menu">
                            ...
                            <li><a href="">My Account <img src="../img/drop-arrow.png" class="drop-arrow-icon"></a>
                                <ul>
                                    ...
                                    <li class='line'><a href="MyChangeTpinServlet">Change T-PIN</a></li>
									<!--<li><a href="MyActivityServlet">My Activity</a></li>-->
									<?php
									if($my_current_plan==1 || $my_current_plan==2 || $my_current_plan==3)
									{
									?>
									<li><a href="MyCurrentPlanServlet">My Membership Plan</a></li>
									<?php
									}
									else if($my_current_plan==4)
									{
									?>
									<li><a href="MyCurrentPlansServlet">My Membership Plan</a></li>
									<?php
									}
								}
								if($kinf==0 || $kinf==-4)
							...
							<?php if($my_current_plan==6) { ?><li><a href="ServiceDmtServlet">Domestic Money Transfer</a></li><?php } ?>
							<?php if($my_current_plan!=6) { ?>
                                ...
                                <ul>
									...
									<li><a href="">Bill Payment</a><img src="../img/drop-arrow-r.png" style="margin:0px;">
										<ul>
											...
											<?php /* ?><li><a href="ServiceElecServlet">Electricity Bill Payment</a></li>
											<li><a href="ServiceDatacardServlet">Datacard Payment</a></li><?php */?>
									<?php
                            ...
                            <li><a href="">Support <img src="../img/drop-arrow.png" class="drop-arrow-icon"></a>
                                <ul><?php if($my_current_plan!=6) { ?>
								<li><a href="BankContactServlet">Bank &amp; Contact Info</a></li><?php } ?>
                            ...
                            <li><a href="">Commission <img src="../img/drop-arrow.png" class="drop-arrow-icon"></a>
                                <ul>
                                    <li><a href="CommissionEarning">My Earning</a></li>
                                    <li><a href="CommissionReport">Commission Receipt</a></li>
                                </ul>
                            </li>
							<?php if($my_current_plan!=6 && $kinf==3 && $ref_val==1) { ?>
                            <li><a href="">Refer &amp; Earn <img src="../img/drop-arrow.png" class="drop-arrow-icon"></a>
                                <ul>
								<li><a href="ReferAndEarn">Quick Stats</a></li>
                                    <li><a href="ReferAndEarnTeam">Affiliate Team</a></li>
                                    <li><a href="ReferAndEarnTxn">Affiliate Txn DMT</a></li>
                                    <li><a href="ReferAndEarnTxn2">Affiliate Txn Other</a></li>
                                    <li><a href="CommissionMyEarning">Affiliate Earnings</a></li>
                                </ul>
                            </li>
							<?php } else if($my_current_plan!=6 && $kinf==3 && $ref_val==0) { ?>
