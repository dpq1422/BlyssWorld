...
function check_values() {
	...
	if(isEmpty(operator)==1)
		error_message+="<li>Select Landline / Broadband Provider.</li>";
	if(isEmpty(mobile)==1)
	...
	else
	{
		...
		$("#error-message").html("Do you want to pay bill for Landline / Broadband?");
		$("#ButtonFirst").hide();
		$("#ButtonSecond").show();
		$("#ViewServlet").show();
		$("#error-box").show();
            ...
            <div class="w3-row-padding w3-margin-top">
            	<div class="w3-col m12 wow bounceIn">
                	<div class="table-box wh w3-left">
                    	<div class="box-head">
                        	<h3>Landline / Broadband Bill Payment</h3>
                        </div>
						<?php
						$msg="";
						...
						if(isset($_POST['RechargeMobile']))
						{
							...
							if($txn_pn==$logged_tpin)
							{
								...
								if($result_transaction!="")
								{
									...
									echo "<script>document.location.href='ServiceLandlineServlet?msg=$msg'</script>";
								}
								else
								{
                        ...
                        <form class="wh w3-left" method="post">
                        	<div class="w3-row-padding w3-margin-bottom">  
                            	...
                            	<div class="w3-col m6 l4 w3-margin-top">
                                	<label>Landline / Broadband Provider</label>	
                                ...
                                <div class="w3-col m6 l4 w3-margin-top">
                                	...
                                	<input id="mobile" name="mobile" type="text" placeholder="Mobile" class="w3-input w3-border w3-round">
                                </div> 
                                <div class="w3-col m6 l4 w3-margin-top">
                                	<label>Amount</label>
