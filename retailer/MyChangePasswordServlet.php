...
function check_values() {
	...
	if(isSize(opass,8,8)==1)
		error_message+="<li>Old password must have 8 characters.</li>";
	if(isSize(npass,8,8)==1)
		error_message+="<li>New password must have 8 characters.</li>";
	if(isSize(cpass,8,8)==1)
	...
	else
	{
		...
		$("#error-message").html("Do you want to change password?");
		$("#ButtonFirst").hide();
		$("#ButtonSecond").show();
		$("#ViewServlet").show();
		$("#error-box").show();
            ...
            <div class="w3-row-padding w3-margin-top">
            	<div class="w3-col m12 wow bounceIn">
                	<div class="table-box wh w3-left">
						...
						<p><b>Passwords must meet the following requirement:</b><br><br>

1. The Password must be of 8 characters only.<br>
2. The Password should be a combination of alphabets, numbers and special characters.<br>
3. The special characters allowed in a Password are: "$#@&*%" .<br>
4. Spaces are not allowed in the Password.<br>
5. Your New Password cannot be the same as any of your previous password.<br>
</p>
                                </div>                                    
                        	</div>
                        </form>
