...
function display_rate(uid,sid,method,amount)
{
	...
	$.ajax({
		...
		success: function( data, textStatus, jqXHR) {
			...
			document.getElementById("ttl").value=parseInt(amount)+parseInt(data);
			*/
			if(amount<=1000)
			{
				charged=10;
			...
			document.getElementById("charges").value=freeze_2place(charges);
			document.getElementById("charged").value=freeze_2place(charged);
			document.getElementById("ttl").value=freeze_2place(parseFloat(amount)+parseFloat(charged));
		}	 
	});
}
...
<body>
	...
	{	
		...
		{
			$result_beneficiary_add=txn_add_benificiary($uid, $cno, $cname, $bno, $bname, $bbname, $acc, $ifsc, $bbankid, 5, 2, 2);//, 5, 0, 0);
		...
		else
		{
			...
			txn_add_benificiary_verfied($uid, $cno, $cname, $bno, $recipient_name, $bbname, $acc, $ifsc, $bbankid, 5, 2, 2);//, 5, 0, 0);
		}
		$msg="";
		if($result_beneficiary_add[0]==0)
		{
	...
	if(isset($_POST['TransferMoney']))
	{
		...
		if($sourcemt==5)
		{
			...
			//echo "$uid, $cno, $cname, $brid, $bno, $bname, $bbname, $bacc, $bifsc, $bbankid, $source, $type, $method, $transamount, $charges321, $charged321, $pan, $aadhar";die();
			include_once('../zf-WalletTxnDmt.php');
			...
			<div class="w3-row-padding w3-center">
				...
				<div class="w3-col l4 w3-padding-32">
					...
					<form class="wh w3-left w3-white w3-padding w3-padding-32 w3-round-large" method="post">
						...
						<div class="w3-bar">
							<input class="w3-button w3-round w3-blue" value="Search" type="submit" name="channel2" style="margin:1px;" />
						</div>
					</form>
					<?php 
					}
					...
					<form class="wh w3-left" method="post">
						<div class="w3-row-padding w3-margin-bottom">  
							...
							<div class="w3-col m6 l3 w3-margin-top">
								...
								<select class="w3-select w3-border w3-round" onchange="pullBankType('3')" required id="banktype">
					...
					<form class="wh w3-left" method="post">
						<div class="w3-row-padding w3-margin-bottom">  
							...
							<div class="w3-col m6 l4 w3-margin-top">
								...
								<input type="hidden" name="sourcemt" id="sourcemt" value="5" />
						...
						<div class="w3-row-padding w3-margin-bottom">  
							...
							<div class="w3-col m6 l4 w3-margin-top">
								<label>Amount</label>
								<input type="text" name="transamount" id="transamount" placeholder="Amount" class="w3-input w3-border w3-round" maxlength="5" onkeyup="calc_ded()">
							</div>
						...
						<div class="w3-row-padding w3-margin-bottom">  
							...
							<div class="w3-col m6 l4 w3-margin-top display-none">
							...
							<div class="w3-col m6 l4 w3-margin-top">
								...
								<input type="text" readonly name="ttl" id="ttl" placeholder="Commission Charged" class="w3-input w3-border w3-round">                                    
							</div>							
						</div>
						<div class="w3-row-padding w3-margin-bottom"> 
