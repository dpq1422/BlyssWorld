            ...
            <div class="w3-row-padding w3-margin-top">
            	<div class="w3-col m12 wow bounceIn">
                	<div class="table-box wh w3-left">
						<?php
						//error_reporting(E_ALL); ini_set('display_errors', 1);die();
						...
						/**************************/
						$s1=$s2=$s3=$s4=$s5="";
						$cond=" where 1=1 and user_id='$logged_user_id' and type in(3,4,5,6,7,8,9,10,11) ";
						...
						$qr="&s1=$s1&s2=$s2&s3=$s3&search=search";
						$i=0;
						?>
                    	<div class="box-head">
                        	<h3>TRANSACTIONS - Prepaid and Bills <span class="w3-right w3-blue w3-center badges"><?php echo $total_records;?></span></h3>
                        </div>
						<div class="table-search-filter wh w3-left">
							<form class="wh w3-left" method="get">
								<ul>
                                    ...
                                    <li>
										<label>Date</label>
                                        <input name="s2" id="s2" onclick="clrval()" value="<?php echo $s2;?>" type="date" placeholder="Date" class="w3-input w3-border w3-round">
                                    </li>
                                    <li>
										<label>Account</label>
                                    ...
                                    <li>
										<label>&nbsp;</label>
										<a href="DownloadUserTxnOtherServlet?1=1<?php echo $qr;?>" class="w3-button w3-green w3-round">Download Excel</a>
                                    </li>                                        
                                </ul>
                            </form>
                        </div>
                        <div class="table-div wh w3-left">
                        	<ul>
								...
								while($user_row=mysql_fetch_array($user_result))
								{
									...
									if($txn_type==3)
										$txn_type="<b class='w3-text-blue'>MOBILE RC</b>";
									else if($txn_type==4)
										$txn_type="<b class='w3-text-blue'>DTH RC</b>";
									else if($txn_type==5)
										$txn_type="<b class='w3-text-green'>POSTPAID</b>";
									else if($txn_type==6)
										$txn_type="<b class='w3-text-orange'>ELECTRICITY</b>";
									else if($txn_type==7)
										$txn_type="<b class='w3-text-orange'>WATER</b>";
									else if($txn_type==8)
										$txn_type="<b class='w3-text-orange'>GAS</b>";
									else if($txn_type==9)
										$txn_type="<b class='w3-text-green'>LANDLINE / BROADBAND</b>";
									else if($txn_type==10)
										$txn_type="<b class='w3-text-green'>DATACARD</b>";
									else if($txn_type==11)
										$txn_type="<b class='w3-text-orange'>INSURANCE</b>";
									...
									$dt2=time();
									if($txn_status2!=5 && $txn_status2!=4 && $txn_status2!=-4 && $dt2-$dt1<=259200)
									{
									...
									$st="";
									$txn_status2="".$txn_status2;
									if($txn_status2=="2" && $user_row['tid']!="0")
										$st=" ".$user_row['tid']." ";
									else if($txn_status2=="2" && $user_row['tid']=="0")
										$st=" ".$user_row['mid']." ";
								?>
                                <li>
									...
									if($txn_status2=="2")
									{
										?>&nbsp;&nbsp;&nbsp;&nbsp;<img src='../img/print.png' 
															onclick='prints("<?php echo $rc_id;?>")' style='margin:-2px 0px;' height='16' title='Print'/><?
									}?></span>
                                </li>
								<?php
								}
