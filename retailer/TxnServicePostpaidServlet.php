            ...
            <div class="w3-row-padding w3-margin-top">
            	<div class="w3-col m12 wow bounceIn">
                	<div class="table-box wh w3-left">
						<?php
						echo "<script>document.location.href='TxnServiceOtherServlet'</script>";
						...
						/**************************/
						$s1=$s2=$s3=$s4=$s5="";
						$cond=" where 1=1 and user_id='$logged_user_id' and type in(5,9,10) ";
						...
						?>
                    	<div class="box-head">
                        	<h3>TRANSACTIONS - BILL PAYMENTS <span class="w3-right w3-blue w3-center badges"><?php echo $total_records;?></span></h3>
                        </div>
                        ...
                        <div class="table-div wh w3-left">
                        	<ul>
								...
								while($user_row=mysql_fetch_array($user_result))
								{
									...
									if($txn_type==5)
										$txn_type="<b class='w3-text-blue'>POSTPAID MOBILE</b>";
									else if($txn_type==9)
										$txn_type="<b class='w3-text-green'>LANDLINE / BROADBAND</b>";
									else if($txn_type==10)
										$txn_type="<b class='w3-text-orange'>DATACARD</b>";
