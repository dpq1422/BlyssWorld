...
<script>
function printreports(multiple,m2)
{
		window.open('printreports.php?result='+multiple+'&results='+m2,'Print Receipt','directories=no,titlebar=no,toolbar=no,location=no,status=no,menubar=no,scrollbars=no,resizable=no,width=600,height=800');
}
</script>
</head>
<body>
                        ...
                        <div class="table-div wh w3-left">
                        	<ul>
                                ...
                                <li>
                                    ...
                                    <span><a style='text-decoration:underline;' href='WalletHistoryUserServlets?s1=<?php echo $user_row['paidon'];?>&search=search'><?php echo $user_row['paidon'];?></a></span>
                                    <span>
										<img src='../img/print.png' 
										onclick="printreports('<?php echo $dt;?>','<?php echo $dt2;?>')" style='margin:-2px 0px;' height='16' title='Print'/>
									</span>
                                </li>
								<?php
								}
