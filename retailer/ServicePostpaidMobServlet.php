...
function check_values() {
	...
	else
	{
		...
		$("#error-message").html("Do you want to pay bill for Postpaid Mobile?");
		$("#ButtonFirst").hide();
		$("#ButtonSecond").show();
		$("#ViewServlet").show();
		$("#error-box").show();
            ...
            <div class="w3-row-padding w3-margin-top">
            	<div class="w3-col m12 wow bounceIn">
                	<div class="table-box wh w3-left">
                    	<div class="box-head">
                        	<h3>Postpaid Mobile Bill Payment</h3>
                        </div>
						<?php
						$msg="";
						...
						if(isset($_POST['RechargeMobile']))
						{
							...
							if($txn_pn==$logged_tpin)
							{
								...
								if($result_transaction!="")
								{
									...
									echo "<script>document.location.href='ServicePostpaidMobServlet?msg=$msg'</script>";
								}
								else
								{
