...
<html>
	<head>
		...
		<style>
			...
			.fb{font-size:24px;line-height:46px;}
			.fm{font-size:18px;}
			.fs{font-size:12px;}
		</style>
	</head>
	<body>
		<div style='border:1px solid #c5c5c5;padding:10px;width:580px;'>
			...
			<table cellpadding="0" cellspacing="0" width='100%'>
				...
				<tr height="30">
					...
					<th align='right'><?php echo $rs['amount'];?>&nbsp;&nbsp;&nbsp;&nbsp;</th>
				...
				<tr height="30">
					<td align="left"><br><b>Generic T&amp;C / Disclaimer</b>
						<ul class='fs'>
							...
							<li>If customer is charged in excess of 1.5% of amount including GST. He/She should complaint about same on BLYSS Customer Care Number.</li>
							<li>BLYSS will not entertain any complaint with reference to any mistake/omission on the part of the sender.</li>
							<li>For any registration related issues the sender should contact thr RO Agent.</li>
						</ul>
					</td>
				</tr>
				<tr>
