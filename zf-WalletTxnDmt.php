...
function txn_add_benificiary($userid, $cno, $cname, $bno, $bname, $bbname, $bacc, $bifsc, $bbankid, $source, $type, $method, $pan, $aadhar)
{
	...
	if(($balance_retailer+$show_user_limit)<$deduction_retailer && $userid!=$testing2)
	...
	if($err=="")
	{
		...
		else
		{
			...
			$qry1="";			
			$qry1="INSERT INTO $bankapi_child_txn.txn_mt_parent(date_time, retailer_id, sender, sname, receiver, receiver_id, rname, rbname, racc, rifsc, rbankid, source, type, method, pre_bal, amount, charges, com_charged, deducted, post_bal) value('$datetime', '$userid', '$cno', '$cname', '$bno', '$brid', '$bname', '$bbname2', '$bacc', '$bifsc', '$bbankid', '$source', '$type', '$method', '$balance_retailer', '$deduction_retailer', '$charges', '$charged', '$ded_ret', '$remain_ret')";
			...
			$qry2="";			
			$qry2="INSERT INTO $bankapi_child_txn.txn_mt_child(txn_id, created_on, user_id, sender_number, sname, receiver_number, receiver_id, rname, rbname, racc, rifsc, rbankid, source, type, method, bal_before, amount, charges, com_charged, deducted, bal_after, updated_on, order_status, ip) value ('$txn_id', '$datetime', '$userid', '$cno', '$cname', '$bno', '$brid', '$bname', '$bbname2', '$bacc', '$bifsc', '$bbankid', '$source', '$type', '$method', '$balance_retailer', '$deduction_retailer', '$charges', '$charged', '$ded_ret', '$remain_ret', '$datetime', '$txn_status', '$user_ip')";
			...
			$qry3="";			
			$qry3="INSERT INTO $bankapi_parent_txn.txn_mt(client_id, order_id, txn_id, created_on, user_id, sender_number, sname, receiver_number, receiver_id, rname, rbname, racc, rifsc, rbankid, source, type, method, bal_before, amount, charges, bal_after, updated_on, mmt_status, ip) value('$clientdbid', '$order_id', '$txn_id', '$datetime', '$userid', '$cno', '$cname', '$bno', '$brid', '$bname', '$bbname2', '$bacc', '$bifsc', '$bbankid', '$source', '$type', '$method', '$balance_admin', '$deduction_admin', '$charges', '$remain_admin', '$datetime', '$txn_status', '$user_ip')";
			...
			if($txn_status==1 || $txn_status==3)
			{
				...
				else if($source==5)
				{
					...
					//{
						...
						$qry="insert into $bankapi_common.eko_receiver_verified(sender, bank, ifsc, receiver_acc_no, receiver_name, receiver_id_type, updated_on, source) value('$cno', '$bbname2', '$bifsc', '$bacc', '$bname', '0', '$datetime_datetime', 3);";
						mysql_query($qry);
					//}
					//return $resulted_data;
				}
...
function txn_add_benificiary_verfied_100100($userid, $cno, $cname, $bno, $bname, $bbname, $bacc, $bifsc, $bbankid, $source, $type, $method, $pan, $aadhar)
{
	$err="";
	$txn_status=1;
	require('zc-gyan-info-admin.php');
...
function show_api_txn_no_by_oid($oid,$userid)
{
	require('zc-gyan-info-admin.php');
	require('zc-commons-admin.php');
	$api_txn_no=0;
	$qry="select * from $bankapi_child_txn.txn_mt_child where user_id='$userid' and order_id='$oid';";
	$result=mysql_query($qry);
	while($rs=mysql_fetch_array($result))
	{
		$api_txn_no=$rs['api_txn_no'];
	}
	return $api_txn_no;
}
function show_api_access_key_by_uid($userid)
{
	require('zc-gyan-info-admin.php');
	require('zc-commons-admin.php');
	$api_key="";
	$call_back="";
	$qry="select * from $bankapi_child_base.api_user where user_id='$userid';";
	$result=mysql_query($qry);
	while($rs=mysql_fetch_array($result))
	{
		$api_key=$rs['api_key'];
		$call_back=$rs['call_back'];
	}
	return array($api_key,$call_back);
}
...
function txn_fund_transfer3($userid, $cno, $cname, $brid, $bno, $bname, $bbname, $bacc, $bifsc, $bbankid, $source, $type, $method, $amount, $charges123, $charged123, $pan, $aadhar)//, $doctype, $docid, $areapincode, $geo
{
	...
	$unpaid=show_unpaid_comm_non_aff($userid);
	$unpaid=$unpaid*.75;
	
	$datetime=$datetime_datetime;
	$balance_retailer=show_txn_user_balance($userid);
	$show_user_limit=show_user_limit($userid);
	if($show_user_limit>0)
		$unpaid=0;
	$balance_client=show_txn_client_balance();
	$balance_client_dummy=show_txn_client_dummy_balance();
	$balance_admin=show_txn_admin_balance($source);
	...
	if(($balance_retailer+$show_user_limit+$unpaid)<($amount+$deduction_retailer))
		$err="Your Balance is low for transaction.";
	...
	{
		$duplicate_txn=check_mt_placed($userid,$brid,$datetime,$source,$type,$method,$amount);
		if($userid=="100329" || $userid==100329)
		$duplicate_txn=0;
		if($duplicate_txn!=0)
		$err="repeated";
		else
		{
			...
			while($amt>=$limit)
			{
				...
				if($limit>2000)
					$deduction_retailer=$deduction_retailer*1.18;
				...
				$rcom=$deduction_retailer-$charges2;
				$rcom=number_format((float)$rcom, 2, '.', '');
				////////////////////do with $limit
				$qry2="";			
				$qry2="INSERT INTO $bankapi_child_txn.txn_mt_child(txn_id, created_on, user_id, sender_number, sname, receiver_number, receiver_id, rname, rbname, racc, rifsc, rbankid, source, type, method, bal_before, amount, charges, com_charged, deducted, bal_after, updated_on, order_status, ip) value ('$txn_id', '$datetime', '$userid', '$cno', '$cname', '$bno', '$brid', '$bname', '$bbname2', '$bacc', '$bifsc', '$bbankid', '$source', '$type', '$method', '$balance_retailer', '$limit', '$charges2', '$deduction_retailer', '$ded_ret', '$remain_ret', '$datetime', '$txn_status', '$user_ip')";
				$order_id=generate_mt_client_txn_child($qry2);
				if($order_id%1000==0)
				{
					//include_once('../functions/_zsms.php');
				...
				$qry3="";			
				$qry3="INSERT INTO $bankapi_parent_txn.txn_mt(client_id, order_id, txn_id, created_on, user_id, sender_number, sname, receiver_number, receiver_id, rname, rbname, racc, rifsc, rbankid, source, type, method, bal_before, amount, charges, bal_after, updated_on, mmt_status, ip) value('$clientdbid', '$order_id', '$txn_id', '$datetime', '$userid', '$cno', '$cname', '$bno', '$brid', '$bname', '$bbname2', '$bacc', '$bifsc', '$bbankid', '$source', '$type', '$method', '$balance_admin', '$limit', '$deduction_admin', '$remain_admin', '$datetime', '$txn_status', '$user_ip')";
				$m_id=generate_mt_admin_txn($qry3);
...
/////LOKESH
	...
	if($parent_01==100001)
		$parent_01_rate=$deduction_client;
	else
		$parent_01=show_user_mt_rate($parent_01, $source, $method, $limit);
	...
	if($userid=="100100")
		$parent_12_rate=5;
				...
				$affiliates=show_my_affiliates($userid);
				$lvl_1_id=$affiliates[0];
				$lvl_2_id=$affiliates[1];
				$lvl_3_id=$affiliates[2];
				$lvl_4_id=$affiliates[3];
				$lvl_5_id=$affiliates[4];
				$lvl_6_id=$affiliates[5];
				$lvl_7_id=$affiliates[6];
				$lvl_8_id=$affiliates[7];
				$lvl_9_id=$affiliates[8];
				$lvl_10_id=$affiliates[9];
				$lvl_11_id=$affiliates[10];
				$lvl_12_id=$affiliates[11];
				...
				$lvl_11_rate=0;
				$lvl_12_rate=0;
				$retailer_rate=$charges2;
				$retailer_rate=number_format((float)$retailer_rate, 2, '.', '');
				
				$lvl_1_earn=$lvl_1_com=number_format((float)(($lvl_1_rate*$retailer_rate/1.18)/100), 5, '.', '');
				$lvl_2_earn=$lvl_2_com=number_format((float)(($lvl_2_rate*$retailer_rate/1.18)/100), 5, '.', '');
				$lvl_3_earn=$lvl_3_com=number_format((float)(($lvl_3_rate*$retailer_rate/1.18)/100), 5, '.', '');
				$lvl_4_earn=$lvl_4_com=number_format((float)(($lvl_4_rate*$retailer_rate/1.18)/100), 5, '.', '');
				$lvl_5_earn=$lvl_5_com=number_format((float)(($lvl_5_rate*$retailer_rate/1.18)/100), 5, '.', '');
				$lvl_6_earn=$lvl_6_com=number_format((float)(($lvl_6_rate*$retailer_rate/1.18)/100), 5, '.', '');
				$lvl_7_earn=$lvl_7_com=number_format((float)(($lvl_7_rate*$retailer_rate/1.18)/100), 5, '.', '');
				$lvl_8_earn=$lvl_8_com=number_format((float)(($lvl_8_rate*$retailer_rate/1.18)/100), 5, '.', '');
				$lvl_9_earn=$lvl_9_com=number_format((float)(($lvl_9_rate*$retailer_rate/1.18)/100), 5, '.', '');
				$lvl_10_earn=$lvl_10_com=number_format((float)(($lvl_10_rate*$retailer_rate/1.18)/100), 5, '.', '');
				$lvl_11_earn=$lvl_11_com=number_format((float)(($lvl_11_rate*$retailer_rate/1.18)/100), 5, '.', '');
				$lvl_12_earn=$lvl_12_com=number_format((float)(($lvl_12_rate*$retailer_rate/1.18)/100), 5, '.', '');
		...
		$client_rate=$deduction_client;
				...
				$client_com_gen_qry="INSERT INTO $bankapi_child_txn.com_generated(order_id, tid, source, type, method, date_time, user_id, amount, charged, retailer_gst, retailer_com, admin_gst, admin_fee, lvl_1_id, lvl_1_com, lvl_1_tds, lvl_1_earn, lvl_2_id, lvl_2_com, lvl_2_tds, lvl_2_earn, lvl_3_id, lvl_3_com, lvl_3_tds, lvl_3_earn, lvl_4_id, lvl_4_com, lvl_4_tds, lvl_4_earn, lvl_5_id, lvl_5_com, lvl_5_tds, lvl_5_earn, lvl_6_id, lvl_6_com, lvl_6_tds, lvl_6_earn, lvl_7_id, lvl_7_com, lvl_7_tds, lvl_7_earn, lvl_8_id, lvl_8_com, lvl_8_tds, lvl_8_earn, lvl_9_id, lvl_9_com, lvl_9_tds, lvl_9_earn, lvl_10_id, lvl_10_com, lvl_10_tds, lvl_10_earn, lvl_11_id, lvl_11_com, lvl_11_tds, lvl_11_earn, lvl_12_id, lvl_12_com, lvl_12_tds, lvl_12_earn) value ('$order_id', '$tid', '$source', '$type', '$method', '$datetime', '$userid', '$limit', '$ded_ret', '$retailer_gst', '$retailer_com', '$admin_gst', '$admin_fee', '$lvl_1_id', '$lvl_1_com', '$lvl_1_tds', '$lvl_1_earn', '$lvl_2_id', '$lvl_2_com', '$lvl_2_tds', '$lvl_2_earn', '$lvl_3_id', '$lvl_3_com', '$lvl_3_tds', '$lvl_3_earn', '$lvl_4_id', '$lvl_4_com', '$lvl_4_tds', '$lvl_4_earn', '$lvl_5_id', '$lvl_5_com', '$lvl_5_tds', '$lvl_5_earn', '$lvl_6_id', '$lvl_6_com', '$lvl_6_tds', '$lvl_6_earn', '$lvl_7_id', '$lvl_7_com', '$lvl_7_tds', '$lvl_7_earn', '$lvl_8_id', '$lvl_8_com', '$lvl_8_tds', '$lvl_8_earn', '$lvl_9_id', '$lvl_9_com', '$lvl_9_tds', '$lvl_9_earn', '$lvl_10_id', '$lvl_10_com', '$lvl_10_tds', '$lvl_10_earn', '$lvl_11_id', '$lvl_11_com', '$lvl_11_tds', '$lvl_11_earn', '$lvl_12_id', '$lvl_12_com', '$lvl_12_tds', '$lvl_12_earn')";
				mysql_query($client_com_gen_qry);
				
				$admin_earn=$retailer_rate-$lvl_1_earn-$lvl_2_earn-$lvl_3_earn-$lvl_4_earn-$lvl_5_earn-$lvl_6_earn-$lvl_7_earn-$lvl_8_earn-$lvl_9_earn-$lvl_10_earn-$lvl_11_earn-$lvl_12_earn;
				$admin_id=$main_admin;
				
				if($lvl_1_id!=0 && $lvl_1_earn!=0)
				{
					$details="Earnings from order no: $order_id of user id: $userid at $datetime";
					$client_com_paid_qry="INSERT INTO $bankapi_child_txn.com_paid_child(order_id, user_id, source, type, method, date_time, details, cr, dr) value ('$order_id', '$lvl_1_id', '$source', '$type', '$method', '$datetime', '$details', '$lvl_1_earn', '0');";
					mysql_query($client_com_paid_qry);
				}
				...
				if($rcom!=0)
				{
					$details="My Earnings from order no: $order_id at $datetime";
					$client_com_paid_qry="INSERT INTO $bankapi_child_txn.com_paid_child(order_id, user_id, source, type, method, date_time, details, cr, dr) value ('$order_id', '$userid', '$source', '$type', '$method', '$datetime', '$details', '$rcom', '0');";
					mysql_query($client_com_paid_qry);
				}
				if($admin_earn!=0)
				{
					...
					$details="Earnings from order no: $order_id of user id: $userid at $datetime";
					$client_com_paid_qry="INSERT INTO $bankapi_child_txn.com_paid_child(order_id, user_id, source, type, method, date_time, details, cr, dr) value ('$order_id', '$admin_id', '$source', '$type', '$method', '$datetime', '$details', '$admin_earn', '$client_rate');";
					mysql_query($client_com_paid_qry);
				}
			}
			if($amt<$limit && $amt>0)
			{
				...
				////////////////////do with $amt
				$qry2="";			
				$qry2="INSERT INTO $bankapi_child_txn.txn_mt_child(txn_id, created_on, user_id, sender_number, sname, receiver_number, receiver_id, rname, rbname, racc, rifsc, rbankid, source, type, method, bal_before, amount, charges, com_charged, deducted, bal_after, updated_on, order_status, ip) value ('$txn_id', '$datetime', '$userid', '$cno', '$cname', '$bno', '$brid', '$bname', '$bbname2', '$bacc', '$bifsc', '$bbankid', '$source', '$type', '$method', '$balance_retailer', '$amt', '$charges2', '$deduction_retailer', '$ded_ret', '$remain_ret', '$datetime', '$txn_status', '$user_ip')";
				$order_id=generate_mt_client_txn_child($qry2);
				if($order_id%1000==0)
				{
					//include_once('../functions/_zsms.php');
				...
				$qry3="";			
				$qry3="INSERT INTO $bankapi_parent_txn.txn_mt(client_id, order_id, txn_id, created_on, user_id, sender_number, sname, receiver_number, receiver_id, rname, rbname, racc, rifsc, rbankid, source, type, method, bal_before, amount, charges, bal_after, updated_on, mmt_status, ip) value('$clientdbid', '$order_id', '$txn_id', '$datetime', '$userid', '$cno', '$cname', '$bno', '$brid', '$bname', '$bbname2', '$bacc', '$bifsc', '$bbankid', '$source', '$type', '$method', '$balance_admin', '$amt', '$deduction_admin', '$remain_admin', '$datetime', '$txn_status', '$user_ip')";
				$m_id=generate_mt_admin_txn($qry3);
...
/////LOKESH
	...
	if($parent_01==100001)
		...
		$parent_01=show_user_mt_rate($parent_01, $source, $method, $amt);
	...
	if($userid=="100100")
		...
		$client_rate=$deduction_client;
				...
				$client_com_gen_qry="INSERT INTO $bankapi_child_txn.com_generated(order_id, tid, source, type, method, date_time, user_id, amount, charged, retailer_gst, retailer_com, admin_gst, admin_fee, lvl_1_id, lvl_1_com, lvl_1_tds, lvl_1_earn, lvl_2_id, lvl_2_com, lvl_2_tds, lvl_2_earn, lvl_3_id, lvl_3_com, lvl_3_tds, lvl_3_earn, lvl_4_id, lvl_4_com, lvl_4_tds, lvl_4_earn, lvl_5_id, lvl_5_com, lvl_5_tds, lvl_5_earn, lvl_6_id, lvl_6_com, lvl_6_tds, lvl_6_earn, lvl_7_id, lvl_7_com, lvl_7_tds, lvl_7_earn, lvl_8_id, lvl_8_com, lvl_8_tds, lvl_8_earn, lvl_9_id, lvl_9_com, lvl_9_tds, lvl_9_earn, lvl_10_id, lvl_10_com, lvl_10_tds, lvl_10_earn, lvl_11_id, lvl_11_com, lvl_11_tds, lvl_11_earn, lvl_12_id, lvl_12_com, lvl_12_tds, lvl_12_earn) value ('$order_id', '$tid', '$source', '$type', '$method', '$datetime', '$userid', '$amt', '$ded_ret', '$retailer_gst', '$retailer_com', '$admin_gst', '$admin_fee', '$lvl_1_id', '$lvl_1_com', '$lvl_1_tds', '$lvl_1_earn', '$lvl_2_id', '$lvl_2_com', '$lvl_2_tds', '$lvl_2_earn', '$lvl_3_id', '$lvl_3_com', '$lvl_3_tds', '$lvl_3_earn', '$lvl_4_id', '$lvl_4_com', '$lvl_4_tds', '$lvl_4_earn', '$lvl_5_id', '$lvl_5_com', '$lvl_5_tds', '$lvl_5_earn', '$lvl_6_id', '$lvl_6_com', '$lvl_6_tds', '$lvl_6_earn', '$lvl_7_id', '$lvl_7_com', '$lvl_7_tds', '$lvl_7_earn', '$lvl_8_id', '$lvl_8_com', '$lvl_8_tds', '$lvl_8_earn', '$lvl_9_id', '$lvl_9_com', '$lvl_9_tds', '$lvl_9_earn', '$lvl_10_id', '$lvl_10_com', '$lvl_10_tds', '$lvl_10_earn', '$lvl_11_id', '$lvl_11_com', '$lvl_11_tds', '$lvl_11_earn', '$lvl_12_id', '$lvl_12_com', '$lvl_12_tds', '$lvl_12_earn')";
				mysql_query($client_com_gen_qry);
...
function refund_amount($oid,$mid,$tid,$refund_source_tid,$source)
{
	...
	if($source==5)
	{
		// get order deducted amount of source wallet
	...
	// get order deducted amount of client wallet
	...
	// get order deducted amount of retailer wallet
