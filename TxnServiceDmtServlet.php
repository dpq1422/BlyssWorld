            	...
            	<div class="w3-col m12 wow bounceIn">
                	<div class="table-box wh w3-left">
						...
						if(isset($_REQUEST['search']))
						{
							...
							if($s4!=""){$cond.=" and (mid='$s4' or tid='$s4') ";}
							if($s5!=""){$cond.=" and (racc='$s5' or bank_ref_no='$s5') ";}
						}
						...
						<div class="table-search-filter wh w3-left">
							<form class="wh w3-left" method="get">
								<ul>
                                    ...
                                    <li>
										<label>TID / eTID</label>
                                        <input name="s4" id="s4" onclick="clrval()" value="<?php echo $s4;?>" type="text" placeholder="TID/eTID" class="w3-input w3-border w3-round">
                                    </li>
                                    <li>
										<label>AccNo / BankRefNo</label>
                                        <input name="s5" id="s5" onclick="clrval()" value="<?php echo $s5;?>" type="text" placeholder="AccNo/BankRefNo" class="w3-input w3-border w3-round">
                                    </li>
                                    <li>
										<label>&nbsp;</label>
                        ...
                        <div class="table-div wh w3-left">
                        	<ul>
								...
								while($user_row=mysql_fetch_array($user_result))
								{
									...
									{
										$oidcheck=$order_id;
										$recheck=" &nbsp;<img title='Re-Check Status of Order $oidcheck' src='img/refresh-icon.png' onclick='recheck5(\"$oidcheck\",\"$txn_status2\",\"$oidcheck\")'>";
									}
								?>
                                <li>
