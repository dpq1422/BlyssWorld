            ...
            <div class="w3-row-padding w3-margin-top">
            	<div class="w3-col m12 wow bounceIn">
                	<div class="table-box wh w3-left">
						...
						$cond=" where 1=1  ";
						if($dt!="")
							$cond=" $cond and date(date_time)='$dt' and user_id='$uid' ";
						...
						$qr="&s1=$s1&s2=$s2&s3=$s3&s4=$s4&s5=$s5&dt=$dt&uid=$uid&search=search";
						$i=0;
						?>
                    	<div class="box-head">
                        	...
                        	<ul>
								...
								while($user_row=mysql_fetch_array($user_result))
								{
									...
									if($amt!=0)
									{
										...
										{
											$user_details=$order_details[0];
											//$user_details=show_user_name($user_details)."<br>($user_details)";
										}
                                ...
                                <li>
									...
									<span><?php echo show_user_name($user_details);?></span>
									<span><?php echo $user_row['order_id'];?></span>
									<span><?php echo $prd_details;?></span>
									<span><?php echo $amt;?> Cr</span>
                                ...
                                <li class='w3-grey'>
									<span><?php echo $user_row['date_time'];?></span>
									<span><b><?php echo $user_row['details'];?></b></span>
									<span>Amount Transacted (Cr / Dr) <b><?php echo $user_row['dr'];?> Dr </b></span>
                                </li>
								<?php
									}
								}
