        ...
        <!--<div class="w3-container">-->
            ...
            <div class="w3-row-padding w3-margin-top">
            	<div class="w3-col m12 wow bounceIn">
						...
						$total_records=show_employees_count($cond);
						$user_result=show_employees_data($cond, $start_from, $num_rec_per_page);
						$qr="&s1=$s1&s2=$s2&s3=$s3&s4=$s4&s5=$s5&search=search";
						$i=0;
						?>
                	<div class="table-box wh w3-left">
                    	<div class="box-head">
                        	<h3>LIST OF EMPLOYEES <span class="w3-right w3-blue w3-center badges"><?php echo $total_records;?></span></h3>
                        </div>
                        <div class="table-div wh w3-left">
                        	<ul>
								...
								while($user_row=mysql_fetch_array($user_result))
								{
									...
									if($user_type==-2)
									{
										$user_type="<b class='w3-text-blue'>CSM</b>";
									}
									if($user_type==-3)
									{
										$user_type="<b class='w3-text-orange'>SM</b>";
									}
									if($user_type==-4)
									{
										$user_type="<b class='w3-text-green'>ASM</b>";
									}
									$rowval="";
									if($i%2==1)
                                ...
                                <li>
                                	<div class="address<?php echo $i;?> inner-add wh w3-left">
                                        ...
                                        <p><strong>City:</strong> <?php echo $user_row['city_name'];?></p>
