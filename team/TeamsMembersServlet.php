        ...
        <!--<div class="w3-container">-->
            ...
            <div class="w3-row-padding w3-margin-top">
            	<div class="w3-col m12 wow bounceIn">
						...
						$total_records=show_team_joined_counts($cond, $logged_user_id);
						$user_result=show_team_joined_datas($cond, $logged_user_id, $start_from, $num_rec_per_page);
						$qr="&s1=$s1&s2=$s2&s3=$s3&s4=$s4&s5=$s5&search=search";
						$i=0;
						?>
                	<div class="table-box wh w3-left">
                    	<div class="box-head">
                        	<h3>LIST OF MEMBERS <span class="w3-right w3-blue w3-center badges"><?php echo $total_records;?></span></h3>
                        </div>
                        ...
                        <div class="table-div wh w3-left">
                        	<ul>
								...
								while($user_row=mysql_fetch_array($user_result))
								{
									...
									$st_link="";
									$team=0;
									$team=show_team_joined_count($user_row['user_id']);
									$retailer=0;
									$retailer=show_retailer_joined_count($user_row['user_id']);
									if($retailer==0)
										$retailer="";
									$user_detail=show_user_detail($user_row['user_id']);
									$user_val=mysql_fetch_array($user_detail);
									$join_date=$user_val['join_date'];
									$user_type=$user_val['user_type'];
									...
									if($is_my_user!=0 && $logged_user_id!=200309)
									{
										$st_link="$st_link
