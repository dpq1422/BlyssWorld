            ...
            <div class="w3-row-padding w3-margin-top">
            	<div class="w3-col m12 wow bounceIn">
                	<div class="table-box wh w3-left">
						...
						//val=show_user_margins_data("m_01000",$userid,"1","1");
						?>
                    	<div class="box-head">
                        	<h3>USER DETAILS</h3>
                        </div>					
                        ...
                        <div class="w3-responsive">
                            ...
                            <table class="w3-table-all" id="myTable" style="border:none;">
								...
								while($margin_row=mysql_fetch_array($margin_result))
								{
									...
									$mins=show_mt_margin($logged_user_id, $source_id, $payment_method);
									if($usertype==12)
										$min=array(show_max($mins[0],6),show_max($mins[1],6),show_max($mins[2],6),show_max($mins[3],6),show_max($mins[4],6));
									else
										$min=$mins;
									
									//2-Marketing Head (8-10)
									if($usertype==2)
									{
										$max=array(8,10,10,10,10);
									}
									//3-Master Distributor (9-10)
									if($usertype==3)
									{
										$max=array(9,10,10,10,10);
									}
									//4-Super Distributor (10-12)
									if($usertype==4)
									{
										$max=array(9,10,12,12,12);
									}
									//5-Distributor (13-15)
									if($usertype==5)
									{
										$max=array(9,10,15,15,15);
									}
									//12-Retailer
									if($usertype==12)
									{
										$max=array(9.5,10.5,20,30,40);
									}
