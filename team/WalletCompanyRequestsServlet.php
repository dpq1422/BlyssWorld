            ...
            <div class="w3-row-padding w3-margin-top">
            	<div class="w3-col m12 wow bounceIn">
                	<div class="table-box wh w3-left">
						...
						$total_records=show_requests_count_dist2($cond, $logged_user_id);
						$user_result=show_requests_data_dist2($cond, $logged_user_id, $start_from, $num_rec_per_page);
						$qr="&s1=$s1&s2=$s2&s3=$s3&s4=$s4&search=search";
						$i=0;ini_set('display_errors', 1);
						?>
                    	<div class="box-head">
                        	<h3>TEAM REQUESTS TO COMPANY <span class="w3-right w3-blue w3-center badges"><?php echo $total_records;?></span></h3>
                        </div>
