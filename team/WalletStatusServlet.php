            ...
            <div class="w3-row-padding w3-margin-top">
            	<div class="w3-col m12 wow bounceIn">
                	<div class="table-box wh w3-left">
						...
						$total_records=show_joined_counts($cond, $logged_user_id);
						$user_result=show_joined_datas($cond, $logged_user_id, $start_from, $num_rec_per_page);
                        ...
                        <div class="table-div wh w3-left">
                        	<ul>
								...
								while($user_row=mysql_fetch_array($user_result))
								{
									...
									$wallet_balance=show_wallet_balance($joined_id);
									if($kyc_status==0)
									{
