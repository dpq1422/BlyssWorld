            ...
            <div class="w3-row-padding w3-margin-top">
            	<div class="w3-col m12 wow bounceIn">
						...
						if($logged_user_type==-4)
							$fld="joined_by_asm";
						$cond=" where 1=1 and $fld='$logged_user_id' ";
                        ...
                        <div class="table-div wh w3-left">
                        	<ul>
                                ...
                                <li>
                                    ...
                                    <span><?php echo show_district_name($distt_id);?></span>
                                    <span><?php echo show_state_name($state_id);?></span>
