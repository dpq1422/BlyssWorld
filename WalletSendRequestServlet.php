...
function check_values() {
	...
	else
	{
		...
		$("#error-message").html("Do you want to send request?");
		$("#ButtonFirst").hide();
		$("#ButtonSecond").show();
		$("#ViewServlet").show();
		$("#error-box").show();
            	...
            	<div class="w3-col m12 wow bounceIn">
                	<div class="table-box wh w3-left">
						...
						if(isset($_POST['GenerateRequest']))
						{
							...
							generate_request($filled_dt,$filled_bank,$filled_method,$filled_refno,$filled_amount,$filled_remark,$company_id,$logged_user_id,$logged_user_name);
                        ...
                        <form class="wh w3-left" method="post">
                        	<div class="w3-row-padding w3-margin-bottom"> 
                                ...
                                <div class="w3-col m6 l4 w3-margin-top">
                                	...
                                	<select id="bnk" name="filled_bank" class="w3-select w3-border w3-round" name="option">
                                        <option value="" required disabled selected>Choose your option</option>
									<?php
									include_once('zf-BankProvider.php');
									$state_result=show_banks_data(" where bank_status=1 or 1=1 ");
									while($state_row=mysql_fetch_array($state_result))
									{
											echo "<option value='".$state_row['bank_id']."'>".$state_row['bank_name']." - ".$state_row['account_no']."</option>";
									}
									?>
                                    </select>
                                </div>
                                ...
                                <div class="w3-col m6 l4 w3-margin-top">
                                	...
                                	<select id="pmeth" name="filled_method" class="w3-select w3-border w3-round" name="option">
                                        <option value="" required disabled selected>Choose your option</option>
  ...
  <div id="error-box" class="w3-modal">
    <div class="w3-modal-content w3-animate-zoom w3-card-4 w3-round list-pop">
      ...
      <div class="w3-container w3-center">
      	<p id="error-message">Do you want to send request?</p>
      </div>  
