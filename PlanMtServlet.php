                        ...
                        <div class="table-div wh w3-left">
                        	<ul>
                                ...
                                <li>
                                    ...
                                    <span><?php echo $user_row['m_01000'];?></span>
                                    <span><?php echo $user_row['m_02000'];?></span>
                                    <span><?php echo $user_row['m_03000'];?></span>
                                    <span><?php echo $user_row['m_04000'];?></span>
                                    <span><?php echo $user_row['m_05000'];?></span>
                                </li>
								<?php
								}
								?>
								<li>
									<div class="w3-row-padding w3-margin-bottom w3-margin-top w3-right-align">
										<a href="PlanMtUpdateServlet?plan=<?php echo $planid;?>" class="w3-button w3-round w3-blue">Modify Rates</a>
									</div>    
								</li>
                            </ul>
                        </div>   
