                	...
                	<div class="table-box wh w3-left">
						...
						if(isset($_POST['UpdateCommission']))
						{
							...
							for($aa=0;$aa<count($oprs);$aa++)
							{
								...
								update_commission_amt($opr,$p1,$p2,$p3,$p4,$p5);
							}
							echo "<script>window.location.href='PlanCommissionServlet';</script>";
						}
						?>
                        	...
                        	<ul>
								...
								<li>
									<div class="w3-row-padding w3-margin-bottom w3-margin-top w3-right-align">
										<button name="UpdateCommission" class="w3-button w3-round w3-blue">Update Commission</button>
									</div>    
								</li>
                            </ul>
							</form>
