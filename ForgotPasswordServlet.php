...
<html>
<head>
<title>Forgot Password :: BlyssPay.com</title>
<?php 
...
<body onload="myFocus()">
	...
	if(isset($_POST['ForgotPassword']))
	{
		...
		else
		{
			...
			$mob=forgot_password($filled_mobile_no, $filled_pass_word, $pass_word);//uid//mob//pwd
			include_once('zf-sms.php');
			if($mob==$filled_pass_word)
			$zsms=create_forgot_msg_matched($pass_word);
			else
			$zsms=create_forgot_msg_not_matched($dtm);
			zsms($mob,$zsms);
