            ...
            <div class="w3-row-padding w3-margin-top">
            	<div class="w3-col m12 wow bounceIn">
                	<div class="table-box wh w3-left">
						...
						?>
                    	<div class="box-head">
                        	<h3>TRANSACTIONS - DTH Recharge <span class="w3-right w3-blue w3-center badges"><?php echo $total_records;?></span></h3>
                        </div>
                        <div class="table-div wh w3-left">
                        	<ul>
								...
								while($mrc_row=mysql_fetch_array($mrc_result))
								{
									...
									if($mmt_type==3)
										$mmt_type="<b class='w3-text-blue'>Prepaid</b>";
									else if($mmt_type==4)
										$mmt_type="<b class='w3-text-green'>DTH</b>";
									else if($mmt_type==5)
										$mmt_type="<b class='w3-text-orange'>PostPaid</b>";
