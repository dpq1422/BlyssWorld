...
include_once('zc-session-admin.php');
if($logged_user_type>1 && $logged_user_type<12)
{
	echo "<script>window.location.href='team/DashboardServlet';</script>";
}
...
$rt_bal=show_rt()-show_dummy_balance();
$rt_bal=number_format((float)$rt_bal, 2, '.', '');
