            	...
            	<div class="w3-row-padding">
                	<div class="w3-col">
                    	<div class="logo w3-left">
                    		<a href="DashboardServlet"><img src="img/logo.png" height="35"></a>
                    	</div>
                        <div class="w3-right">
                            <div class="header-main-right-top wh w3-right">
                                <div class="wh w3-right w3-right-align">
                                    <span><a ><img src="img/refresh-icon.png" onclick="window.location.reload();" class="refresh w3-right-align"></a>Real Time : <strong><?php echo "ACH : $rt5 / RCH : $rt6";?></strong></span>
                                </div>
                                <div class="wh w3-right w3-right-align">
